...
def process_batch(batch):
    ...
    test, question, tag, correct, totaltime, a,b,c,d,e,f,g,h ,mask = batch
    ...
    return (test, question, tag, correct, mask, interaction,
             totaltime.to(torch.int64), a.to(torch.int64), b.to(torch.int64), c.to(torch.int64), d.to(torch.int64), e.to(torch.int64), f.to(torch.int64), g.to(torch.int64), h.to(torch.int64)
            )
