...
def parse_args():
    ...
    parser.add_argument("--n_embdings", default={}, type=dict, help="Feature number")
    parser.add_argument("--allF", default=0, type=int, help="Feature nunique")
    ...
    parser.add_argument("--iter", default=1000, type=int, help="n_estimators")
    ...
    parser.add_argument(
        "--isinfer", default=False, type=bool, help="train or inference"
    )
    ...
    parser.add_argument(
        "--lr", default=0.0003, type=float, help="learning rate"
    )  # 0.003788
    ...
    parser.add_argument(
        "--pos", default=False, action="store_true", help="position encoding"
    )

    parser.add_argument(
        "--window", default=True, action="store_true", help="sliding window"
    )
    parser.add_argument("--stride", default=101, type=int, help="window stride")
    parser.add_argument(
        "--shuffle", default=False, action="store_true", help="data shuffle option"
    )
