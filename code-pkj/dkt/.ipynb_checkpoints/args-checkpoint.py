...
def parse_args():
    ...
    parser.add_argument(
        "--aug", default=False, type=bool, help="augmentation"
    )
    
    parser.add_argument(
        "--file_name", default="train_test_data2.csv", type=str, help="train file name"
    )
    ...
    parser.add_argument('--cate_feats', type=list,
                        default=["assessmentItemID0", 'assessmentItemID1', 'assessmentItemID2', 'testId0', 'testId1', 'KnowledgeTag', 'hour', 'month'], help='category feature')

    ### continous featurs
    parser.add_argument('--conti_feats', type=list, default=['Timestamp'], help = 'continuos feature')
    ...
    parser.add_argument("--lr", default=0.0001, type=float, help="learning rate") # 0.003788
